...
MouseArea {
    ...
    function clampVal(v: real, min: real, max: real): real {
    ...
    Shape {
        ...
        ShapePath {
            ...
            fillGradient: RadialGradient {
                ...
                GradientStop {
                    position: root.circleRadius > 0 ? root.clampVal(1 - 0.2 * root.endRadius / root.circleRadius, 0.01, 0.99) : 0.01
                    color: Qt.alpha(base.color, 1)
                }
                GradientStop {
                    position: 1
                    color: Qt.alpha(base.color, root.endRadius > 0 ? root.clampVal((root.circleRadius / root.endRadius - 0.9) / 0.1, 0, 1) : 0)
                }
            }

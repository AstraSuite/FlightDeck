...
void HyprlandSchema::buildAliases() {
    ...
    const QList<QPair<QString, QString>> commonAliases = {
        ...
        { QStringLiteral("cursorHideOnTablet"), QStringLiteral("cursor:hide_on_tablet") },
        { QStringLiteral("cursorZoomRigid"), QStringLiteral("cursor:zoom_rigid") },
        { QStringLiteral("cursorZoomDetachedCamera"), QStringLiteral("cursor:zoom_detached_camera") },
        { QStringLiteral("cursorHotspotPadding"), QStringLiteral("cursor:hotspot_padding") },
        { QStringLiteral("cursorDefaultMonitor"), QStringLiteral("cursor:default_monitor") },
        { QStringLiteral("cursorSyncGsettingsTheme"), QStringLiteral("cursor:sync_gsettings_theme") },
        { QStringLiteral("cursorWarpBackAfterNonMouseInput"), QStringLiteral("cursor:warp_back_after_non_mouse_input") },
        { QStringLiteral("cursorInvisible"), QStringLiteral("cursor:invisible") },
        { QStringLiteral("cursorMinRefreshRate"), QStringLiteral("cursor:min_refresh_rate") },
